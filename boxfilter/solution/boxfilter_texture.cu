...
texture<float> tex_f32;

// TODO textures (easy)
// TODO shared memory (advanced)
__global__
static void boxfilter(int nx, int ny, int *dst, const int *src, size_t off)
{
...
// divide and round up
static unsigned divup(unsigned num, unsigned denom)
{
